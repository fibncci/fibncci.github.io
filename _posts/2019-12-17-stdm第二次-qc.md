...
SUPPDM-Supplemental Qualifiers DM
SUPPEG-Supplemental Qualifiers EG
SUPPPE-Supplemental Qualifiers PE
...
```
OTE: SQL 表 SHR3680_.DM 已创建为类似:
create table SHR3680_.DM( label='人口学资料' bufsize=262144 )
  (
   PUB_TID char(50) informat=$50. label='表',
   PUB_TNAME char(100) informat=$100. label='表名称',
   PUB_RID num informat=1. label='记录ID',
   SUBJECT_REF_FIELD char(20) informat=$20. label='受试者信息记录ID',
   SUBJID char(500) informat=$500. label='受试者代码',
   STUDYID char(500) informat=$500. label='项目代码',
   LOCKSTAT char(10) format=$LOCKSTA. informat=$10. label='CRF状态',
   SITENAME char(500) informat=$500. label='研究中心名称',
   SITEID char(500) informat=$500. label='研究中心编号',
   INVNAME char(500) informat=$500. label='研究者姓名',
   INVID char(500) informat=$500. label='研究者代码',
   VISIT char(10) format=$VISIT. informat=$10. label='访视',
   VISITNUM char(10) format=$VISITNU. informat=$10. label='访视编号',
   SVNUM char(20) informat=$20. label='访视内序号',
   ICFDAT num format=YYMMDD10. informat=YYMMDD10. label='知情同意书签署日期',
   BRTHDAT num format=YYMMDD10. informat=YYMMDD10. label='出生日期',
   AGE char(500) informat=$500. label='年龄',
   AGEU char(10) format=$AGEU. informat=$10. label='年龄单位',
   SEX char(10) format=$SEX. informat=$10. label='性别',
   ETHNIC char(10) format=$ETHNIC. informat=$10. label='民族',
   ETHNICOT char(500) informat=$500. label='其他民族',
   USERID char(500) informat=$500. label='创 建 人',
   UNITID char(500) informat=$500. label='创建单位',
   CREATETIME num format=DATETIME20. informat=DATETIME20. label='创建时间',
   MODIFYUSERID char(500) informat=$500. label='修 改 人',
   LASTMODIFYTIME num format=DATETIME20. informat=DATETIME20. label='修改时间'
  );
...
create table DF3.HU( compress=CHAR  bufsize=65536 )
  (
   STUDYID char(30) informat=$500. label='研究代码',
   DOMAIN char(2) label='域名缩写',
   USUBJID char(50) label='受试者唯一编码',
   SUBJID char(5) informat=$500. label='本研究内受试者编码',
   RFSTDTC char(19) label='受试者参考开始日期/时间',
   RFENDTC char(19) label='受试者参考结束日期/时间',
   RFXSTDTC char(19) label='首次研究治疗日期/时间',
   RFXENDTC char(19) label='末次研究治疗日期/时间',
   RFICDTC char(19) label='知情同意日期/时间',
   RFPENDTC char(19) label='参加研究结束日期/时间',
   DTHDTC char(19) informat=$500. label='死亡日期/时间',
   DTHFL char(1) label='受试者死亡标记',
   SITEID char(2) informat=$500. label='研究中心识别变量',
   INVID char(10) informat=$500. label='研究者识别变量',
   INVNAM char(10) informat=$500. label='研究者姓名',
   BRTHDTC char(19) label='出生日期/时间',
   AGE num label='年龄',
   AGEU char(5) label='年龄单位',
   SEX char(2) label='性别',
   RACE char(5) label='种族',
   ARMCD char(20) format=$FZPLDOS. informat=$10. label='计划分组代码',
   ARM char(14) label='计划分组描述',
   ACTARMCD char(20) label='实际分组代码',
   ACTARM char(14) label='实际分组描述',
   COUNTRY char(5) label='国家'
  );
