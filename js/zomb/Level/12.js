...
oS.Init({
		...
		PicArr:function(){
			...
			return ['../js/zomb/images/interface/background2.jpg','../js/zomb/images/interface/Tombstones.png','images/interface/Tombstone_mounds.png',
				PicArr[Pro.CardGif],PicArr[Pro.NormalGif]]
		}(),
		backgroundImage:'../js/zomb/images/interface/background2.jpg',
		CanSelectCard:1,
		DKind:0,
		SunNum:50,
		LevelName:'关卡 2-2',
		...
		LoadMusic:function(){NewEle('oEmbed','embed','width:0;height:0',{src:'../js/zomb/music/Look up at the.swf'},EDAll)},
		...
		FlagToEnd:function(){
			NewImg('imgSF','../js/zomb/images/Card/Plants/FumeShroom.png','left:587px;top:270px',EDAll,{onclick:function(){SelectModal(0)}});
			NewImg('PointerUD','../js/zomb/images/interface/PointerDown.gif','top:235px;left:596px',EDAll);
		}
});
